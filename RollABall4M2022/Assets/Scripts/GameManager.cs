...
{
    public static GameManager Instance; //  instacia do singleton

    private void Awake()
    {
        // condiçao de criação do singleton 
        if (Instance == null)
        {
            Instance = this;
    ...
    void Start()
    {
        // se estiver inicializando a cena a partir de initialization, carregue o jogo do jeito de antes 
